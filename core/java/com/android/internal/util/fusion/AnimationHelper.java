...
public class AnimationHelper {
    ...
    public static int[] getAnimations(int mAnim) {
        ...
        switch (mAnim) {
            case ANIMATION_FADE:
                anim[0] = R.anim.slow_fade_out;
                anim[1] = R.anim.slow_fade_in;
                break;
            case ANIMATION_SLIDE_RIGHT:
                anim[0] = R.anim.slide_out_right_ribbon;
                anim[1] = R.anim.slide_in_right_ribbon;
                break;
            case ANIMATION_SLIDE_LEFT:
                anim[0] = R.anim.slide_out_left_ribbon;
                anim[1] = R.anim.slide_in_left_ribbon;
                break;
            case ANIMATION_SLIDE_UP:
                anim[0] = R.anim.slide_out_down_ribbon;
                anim[1] = R.anim.slide_in_up_ribbon;
                break;
            case ANIMATION_SLIDE_DOWN:
                anim[0] = R.anim.slide_out_up;
                anim[1] = R.anim.slide_in_down;
                break;
            case ANIMATION_SLIDE_RIGHT_NO_FADE:
                anim[0] = R.anim.slide_out_right_no_fade;
                anim[1] = R.anim.slide_in_right_no_fade;
                break;
            case ANIMATION_SLIDE_LEFT_NO_FADE:
                anim[0] = R.anim.slide_out_left_no_fade;
                anim[1] = R.anim.slide_in_left_no_fade;
                break;
            case ANIMATION_TRANSLUCENT:
                anim[0] = R.anim.translucent_exit_ribbon;
                anim[1] = R.anim.translucent_enter_ribbon;
                break;
            case ANIMATION_GROW_SHRINK:
                anim[0] = R.anim.shrink_fade_out_ribbon;
                anim[1] = R.anim.grow_fade_in_ribbon;
                break;
            case ANIMATION_GROW_SHRINK_CENTER:
                anim[0] = R.anim.shrink_fade_out_center_ribbon;
                anim[1] = R.anim.grow_fade_in_center_ribbon;
                break;
            case ANIMATION_GROW_SHRINK_LEFT:
                anim[0] = R.anim.shrink_fade_out_left_ribbon;
                anim[1] = R.anim.grow_fade_in_left_ribbon;
                break;
            case ANIMATION_GROW_SHRINK_RIGHT:
                anim[0] = R.anim.shrink_fade_out_right_ribbon;
                anim[1] = R.anim.grow_fade_in_right_ribbon;
                break;
            case ANIMATION_GROW_SHRINK_BOTTOM:
                anim[0] = R.anim.shrink_fade_out_from_bottom_ribbon;
                anim[1] = R.anim.grow_fade_in_from_bottom_ribbon;
                break;
        }
        return anim;
    }
