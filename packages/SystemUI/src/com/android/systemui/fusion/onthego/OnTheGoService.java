...
*    Credits: The NamelessROM Project
*
...
package com.android.systemui.fusion.onthego;
...
import com.android.internal.util.fusion.ShakeDetector;
...
public class OnTheGoService extends Service implements ShakeDetector.Listener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent == null || !FusionUtils.hasCamera(this)) {
            stopSelf();
    ...
    private void getCameraInstance(int type) throws RuntimeException, IOException {
        ...
        if (!FusionUtils.hasFrontCamera(this)) {
            mCamera = Camera.open();
            return;
        }
